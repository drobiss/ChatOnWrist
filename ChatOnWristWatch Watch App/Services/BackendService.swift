...
class BackendService: ObservableObject {
    ...
    func autoPairDevice(userToken: String, deviceType: String = "watch") async -> Result<DevicePairResponse, BackendError> {
        let endpoint = "/device/auto-pair"
        let request = AutoPairRequest(deviceType: deviceType)
